...
export const WorkTimeChart = (props) => {
    ...
    return (
        ...
        >
          ...
          <XAxis dataKey="fullDate" tick={<CustomizedXAxisForChart />} />
          <YAxis />
          <Tooltip />
          <Legend 
          wrapperStyle={{
          ...
          <Line strokeWidth={2} name="Total Work Time (Hours)" type="monotone" dataKey="timeWorkedAsHours" stroke="#8884d8" />
